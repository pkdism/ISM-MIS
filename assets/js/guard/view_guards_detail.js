$(document).ready(function() {
	...
	$("#currentTable").delegate(".photo-zoom", "mouseenter", function(e) {
		e.preventDefault();
		console.log(e);
	...
	$("#currentTable").delegate(".photo-zoom", "mouseout", function(e) {
		e.preventDefault();
		photo.hide();
	});
	
	$("#archivedTable").delegate(".photo-zoom", "mouseenter", function(e) {
		e.preventDefault();
		console.log(e);
		var imageUrl = $(this).data('photo-url');
		// console.log(imageUrl);
	...
	$("#archivedTable").delegate(".photo-zoom", "mouseout", function(e) {
		e.preventDefault();
		photo.hide();
	});
