<div class="row">
	<div class="col-sm-12">
	<?php echo form_open('subject_mapping/main') ?>
    ...
    <?php if($this->input->post('department') || $this->input->post('course') || $this->input->post('branch') || $this->input->post('semester')){ ?>
                               ...
                               <ol class="breadcrumb">
                                	<?php if($this->input->post('department'))
											echo "<li> ".$this->sbasic_model->getDepatmentById($this->input->post('department'))->name."</li>";
									 ?>
                                     <?php if($this->input->post('course'))
											echo "<li>  ".$this->sbasic_model->getCourseById($this->input->post('course'))->name."</li>";
									 ?>
                                      <?php if($this->input->post('branch'))
											echo "<li>  ".$this->sbasic_model->getBranchById($this->input->post('branch'))->name."</li>";
									 ?>
                                     <?php if($this->input->post('semester'))
											echo "<li>  ".$this->input->post('semester')."</li>";
									 ?>
									 </ol>
                                </div>
                                <?php } ?>
	...
	<div class="box box-solid box-primary">
        ...
        <div id="wait"></div>
            <table class="table table-bordered">
                ...
                <tbody>
                <?php
					echo form_hidden('dept',$this->input->post('department_name'));
                ...
                <?php $i=0; foreach($subject as $s) { ?>
                	<tr id="row-<?php echo $i ?>">
                    	<td><?php echo $this->basic_model->get_subject_details($s->id)->subject_id; echo form_hidden('subId[]',$s->id); echo form_input(array('name' => 'subM[]', 'type'=>'hidden', 'id' =>'m-'.$i,'value'=>'1' )); ?></td>
...
<script type="text/javascript">
	...
	function addRow(id){
				var s=id+40;
			 tr=$('#row-'+id).clone();
			 tr.children().children('#m-'+id).val('0').attr('id','m-'+s);
