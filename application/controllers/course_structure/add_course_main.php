...
class Add_course_main extends MY_Controller
{
	...
	public function index($error='')
	{
		...
		$this->load->view('course_structure/add_course_main',$data);
		$this->drawFooter();
	}
	public function add()
    {
		...
		$course_result = $this->basic_model_main->get_course_details_by_id($course_details['id']);
		if(!$course_result)
			$result = $this->basic_model_main->insert_course($course_details);
		else
			$result = false;
		...
		redirect("course_structure/add_course_main");
	  }
}
?>