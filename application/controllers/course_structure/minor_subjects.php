...
class Minor_subjects extends MY_Controller
{
	...
	public function index($error='')
	{
		...
		if($this->input->post() == false)
			redirect("course_structure/offer_minor_home");
		...
		$this->drawHeader();
		$this->load->view('course_structure/minor_subjects',$data);
		$this->drawFooter();
	}
	...
	public function CreateMapping()
	{
		...
		if($result_del)
		{
			...
			$this->session->set_flashdata("flashSuccess","Minor Subjects Added Successfully");
			redirect("course_structure/offer_minor_home");
		}
		else
		{
